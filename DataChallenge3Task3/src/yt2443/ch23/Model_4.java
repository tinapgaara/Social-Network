...
public class Model_4 implements IModel {

	/*
	public static final long ONE_YEAR_InMillis = 31536000000L;
	//*/
	
	private ModelParams_4 m_params;
	
	public Model_4(ModelParams_4 params) {
	...
	private float calcProb_ForTestCheckinItem(CheckinItem item_test,
		...
		if (nNumOfTimeUnits == 0) { // no time divide
			...
			for (CheckinItem item_train : listCheckinItems_train) {
				...
				if (item_test.m_byTimeUnit == item_train.m_byTimeUnit) {
