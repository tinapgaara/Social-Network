...
public class Matcher {
	...
	public LinkSet doMatch(IModel model,
		...
		for (Integer intUserId_test : m_mapTestDataset.keySet()) {
			...
			if (userInfo_test != null) {
				...
				matchTheUser(result, model, intUserId_test, userInfo_test,
		...
		while (cLinks_now < cTotalUsers_test) {
			...
			//*
			matchForUsers_NoLinkFoundSoFar(result, model, nMaxNumOfCandidateLinks_Phase2);
			//*/
	...
	******************************************************************************/
	...
	private void matchTheUser(LinkSet result, IModel model,
			Integer intUserId_test, UserInfo userInfo_test,
		...
		for (Integer intUserId_train : m_mapTrainDataset.keySet()) {
			...
			similarity = model.calcSimilarity(userInfo_test, userInfo_train);
	...
	private void matchForUsers_NoLinkFoundSoFar(LinkSet result, IModel model,
			int nMaxNumOfCandidateLinks_Phase2) {
